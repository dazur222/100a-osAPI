...
//      try { const data = await client.db(dbName).collection("eventos").find().toArray(); return data;} 
//     catch (error) { console.error(error); return []; }
// }
...
// async function getEventosbyName(eventoName){
//   try { const data = await client.db(dbName).collection("eventos").find({evento: eventoName}).toArray(); return data;}
//   catch (error) { console.error(error); return []; }
// }
